...
module LinCAS::Internal
    ...
    # internal.lc_class_define_method(SmathM,"s_cos",smath_cos,          1)
    # internal.lc_class_define_method(SmathM,"s_acos",smath_acos,        1)
    # internal.lc_class_define_method(SmathM,"s_sin",smath_sin,          1)
    # internal.lc_class_define_method(SmathM,"s_asin",smath_asin,        1)
    # internal.lc_class_define_method(SmathM,"s_tan",smath_tan,          1)
    # internal.lc_class_define_method(SmathM,"s_atan",smath_atan,        1)
    # internal.lc_class_define_method(SmathM,"s_cos",smath_cos,          1)
    # internal.lc_class_define_method(SmathM,"s_exp",smath_exp,          1)
    # internal.lc_class_define_method(SmathM,"s_log",smath_log,          1)
    # internal.lc_class_define_method(SmathM,"s_sqrt",smath_sqrt,        1)
    # internal.lc_class_define_method(SmathM,"variable",smath_variable,  1)
    # internal.lc_class_define_method(SmathM,"constant",smath_const,     1)
