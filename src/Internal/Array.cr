...
module LinCAS::Internal
    ...
    def self.new_ary
        ary    = lincas_obj_alloc LcArray, @@lc_array
        ary.id = ary.object_id
        return ary.as( LcVal)
    end
    ...
    def self.lc_ary_allocate(klass :  LcVal)
        ...
        ary       = lincas_obj_alloc LcArray, klass
        ary.id    = ary.object_id
        return ary.as( LcVal)
    end
    ...
    def self.init_array
        ...
        define_protected_method(@@lc_array,"init", lc_ary_init,            1)
        ...
        define_method(@@lc_array,"[]",             lc_ary_index,           1)
        define_method(@@lc_array,"[]=",            lc_ary_index_assign,    2)
        ...
        define_method(@@lc_array,"size",           lc_ary_len,             0)
        ...
        define_method(@@lc_array,"reverse!",       lc_ary_o_reverse,       0)
        ...
        define_method(@@lc_array,"sort_by!",       lc_ary_o_sort_by,       0)
        ...
        define_method(@@lc_array,"map_with_index!",lc_ary_o_map_with_index,0)
        define_method(@@lc_array,"compact",        lc_ary_compact,         0)
        define_method(@@lc_array,"compact!",       lc_ary_o_compact,       0)
