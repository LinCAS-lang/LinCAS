...
module LinCAS::Internal
    ...
    def self.init_string
        ...
        define_allocator(@@lc_string, lc_string_allocate)

        define_method(@@lc_string,"+",       lc_str_add,        1)
        define_method(@@lc_string,"concat",  lc_str_concat,    -1)
        ...
        define_method(@@lc_string,"insert",  lc_str_insert,     2)
        define_method(@@lc_string,"size",    lc_str_size,       0)
        alias_method_str(@@lc_string,"size","length"             )
        define_method(@@lc_string,"upcase!", lc_str_upr_o,      0)
        define_method(@@lc_string,"upcase",  lc_str_upr,        0)
        define_method(@@lc_string,"lowcase!",lc_str_lwr_o,      0)
        define_method(@@lc_string,"lowcase", lc_str_lwr,        0)
        define_method(@@lc_string,"split",   lc_str_split,     -1)
        define_method(@@lc_string,"to_i",    lc_str_to_i,       0)
        define_method(@@lc_string,"to_f",    lc_str_to_f,       0)
        define_method(@@lc_string,"to_s",    lc_obj_self,       0)
        define_method(@@lc_string,"to_sym",  lc_str_to_symbol,  0)
        define_method(@@lc_string,"hash",    lc_str_hash,       0)
        define_method(@@lc_string,"each_char",lc_str_each_char, 0)
        define_method(@@lc_string,"chars",   lc_str_chars,      0)
        define_method(@@lc_string,"compact", lc_str_compact,    0)
